...
const MainMap = () => {
  ...
  return (
    <div className="h-screen flex">
      <MapContainer className="z-0 w-full h-full" center={[51.4416, 5.4697]} zoom={12}>
        <TileLayer
...
const DragHandle = ({ onClick }: { onClick: () => void }) => {
  return (
    <button onClick={onClick} className="absolute left-0 right-0 bottom-0 z-10 flex justify-center bg-neutral-900 p-4">
